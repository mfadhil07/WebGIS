...
Route::get('/a_daftar/tambah_pengunjung/{id}', [DashboardController::class, 'tambah_pengunjung']);
Route::get('/a_daftar/tambah_image/{id}', [DashboardController::class, 'tambah_image']);
Route::post('/a_daftar/update_pengunjung', [DashboardController::class, 'update_pengunjung']);
Route::get('/a_maps', [AdminController::class, 'maps']);
