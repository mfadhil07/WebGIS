        ...
        <div class="grid grid-cols-2 gap-1 ml-10 mt-2">
            ...
            <div class="mt-2">
                ...
                <select name="kategori" id="kategori"
                    class="select max-w-xs select-accent w-80 value="{{ $daftar->kategori }}">
                    <option value="value=">{{ $daftar->kategori }} </option>
            ...
            <div class="border border-dashed border-gray-500 relative mt-16 w-80 h-40">
                <label for="img" class="form-label inline-block mb-2 text-black"> Upload foto wisata :
                    jpg,png,jpeg</label>
                {{-- <img name="img" class="img-preview" src=" {{ asset('') }}/{{ $daftar->img }}" alt=""> --}}
                <input type="file" name="photos[]" id="inputImage" multiple onchange="previewImage()"
                    class="@error('image') is-invalid @enderror block w-full text-sm mt-32 text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" />
                @error('photos')
                    <label class="text-red-700">{{ $message }}</label>
                @enderror
                <hr class="my-4">
            ...
            <div class="mt-20">
                <div class="flex justify-start">
                    <div class="flex ml-10 mb-10 mt-4">
                        <button
