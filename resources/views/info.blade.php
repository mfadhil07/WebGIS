...
@section('isi')
    ...
    <form class="flex justify-end" action="/info">
        <div class="absolute border-2 w-1/4 rounded-btn mb-20">
    ...
    <div class="grid grid-cols-3 gap-3 mt-16 ml-2 ">
                ...
                <div class="rounded-lg shadow-lg bg-white max-w-sm">
                    ...
                    <div class="p-2">
                        ...
                        <div class="flex items-start">
                            </svg> <span class="ml-1 text-sm text-center"> Jam Buka - Tutup : {{ $item->jam }}</span>
                        </div>
                        <div class="flex items-start">
                            </svg> <span class="ml-1 text-sm text-center">Tiket Masuk : {{ $item->tiket }}</span>
                        </div>
                        <div class="ml-1">
                            <p class="text-sm"> Kategori Wisata : <span class="text-2sm text-semibold"> <button
                        ...
                        <div class="flex items-start">
                            </svg> <span class="ml-1 text-sm text-black  text-start">Deskripsi : <span
                                    class="ml-1">{{ $item->deskripsi }} </span> </span>
                        </div>
                    </div>
                    <div class="flex justify-end mt-2 mr-3 mb-2 align-end">
                        <a href="/det/{{ $item->id }}"> <button
