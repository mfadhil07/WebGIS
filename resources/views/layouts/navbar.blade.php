                            ...
                            <nav class="mt-6">
                                ...
                                <div class="flex flex-wrap">
                                    <button
                                        ...
                                        <div>
                                            <p class="flex ml-1 font-bold">Admin</p>
                                        </div>
                                        <span class=" ml-4 text-2sm hidden md:inline-block">
                                            {{ auth()->user()->username }}
                                        </span>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 ml-14 w-full flex items-end"
