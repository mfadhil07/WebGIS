        ...
        <div class="w-1/3 ml-1">
            ...
            <div class="flex flex-row">
                <div class="flex flex-wrap">
                    <div class="w-full h-full sm:w-6/12 md:w-4/12 mt-2 ml-2">
            ...
            <div id="lokasi" class="pl-3">
                @foreach ($daftar as $item)
                    <div class="mt-2 h-30 border-2 border-gray-400 rounded-lg pr-4">
                        ...
                        <div class="flex ml-2">
                            <span class="ml-1 text-sm">Alamat : {{ $item->kecamatan }} , Desa
                                {{ $item->desa }}</span>
                        </div>
                        <div class="flex  ml-2">
                            <span class="ml-1  text-sm text-center"> Buka-Tutup : {{ $item->jam }}</span>
                        </div>
                        <div class="flex ml-2">
                        ...
                        <div class="stat mt-0">
                            <div class="flex justify-end">
                                ...
                                <button
                                    ...
                                    type="button"><a href="/rute">Rute</a> </button>
                            </div>
                        </div>
                    </div>
                @endforeach
...
<script>
    ...
    <div class="stat mt-0">
        <div class="flex justify-end">
            ...
            <button
                class="text-green-500 border border-green-500 hover:bg-green-500 hover:text-white active:bg-green-600 font-bold uppercase text-xs px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                type="button"><a href="/det/${response.id}"> Detail </a></button>
            <button
                class="text-gray-700 border border-gray-700 hover:bg-gray-700 hover:text-white active:bg-gray-700 font-bold uppercase text-xs px-4 py-2 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                type="button"><a href="/rute">Rute</a></button>
        </div>
